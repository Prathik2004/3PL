...
const ExportButton = () => {
  ...
  return (
    ...
    className="w-[110.35px] h-9 py-2 px-6 flex items-center justify-center bg-[#E2E8F0] border border-[#E2E8F0] rounded-lg gap-2 active:scale-95 transition-transform hover:bg-slate-300 cursor-pointer">
