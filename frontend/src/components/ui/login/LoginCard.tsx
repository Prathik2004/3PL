...
const LoginCard = () => {
  ...
  return (
    <div className='shadow-[0_1px_1px_rgba(0,0,0,0.05),0_4px_6px_rgba(34,42,53,0.04),0_24px_68px_rgba(47,48,55,0.05),0_2px_3px_rgba(0,0,0,0.04)] p-8 border border-[#E2E8F0] rounded-xl w-[30%] flex flex-col'>
        {/* HEADING */}
